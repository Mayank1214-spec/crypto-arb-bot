...
export class ArbitrageEngine {
  ...
  private monitorOpenTrades(key: string, currentPrice: PriceData) {
    ...
    for (const trade of this.trades) {
      ...
      if (trade.opportunity.buyExchange === "Deribit") closeLongPrice *= buyExchangeData.underlyingPrice;
      ...
      if (trade.opportunity.sellExchange === "Deribit") closeShortPrice *= sellExchangeData.underlyingPrice;

      if (!closeLongPrice || !closeShortPrice) continue;
